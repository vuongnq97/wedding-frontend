...
export function PublicCoupleSection({ data }: PublicCoupleSectionProps) {
    ...
    return (
        <section className="py-16 md:py-24 bg-background" id="couple">
            <div className="layout-container max-w-[960px] mx-auto px-4 sm:px-10">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="flex flex-col items-center text-center group">
                        <div className="w-64 h-64 rounded-full overflow-hidden border-[6px] border-background shadow-xl mb-6 relative ring-1 ring-border">
                        ...
                        <p className="mt-4 text-muted-foreground max-w-xs text-sm leading-relaxed italic">
                            {t('groom.bio')}
                        </p>
                    </div>
