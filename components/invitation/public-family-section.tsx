        ...
        <section className="py-16 bg-surface">
            <div className="layout-container max-w-[900px] mx-auto px-4 sm:px-10 text-center">
                ...
                <div className="grid md:grid-cols-2 gap-8 md:gap-16 relative items-start">
                    <div className="hidden md:block absolute left-1/2 top-4 bottom-4 w-[1px] bg-gradient-to-b from-transparent via-border to-transparent -translate-x-1/2"></div>

                    {/* Groom's Family */}
                    <div className="flex flex-col gap-4 p-6 rounded-2xl hover:bg-muted transition-colors duration-300">
                        <h3 className="text-xl font-bold text-foreground font-display uppercase tracking-widest text-xs text-primary">
                            {t('groomFamily')}
                        </h3>
                        <div className="space-y-3">
                            <p className="text-sm font-semibold text-muted-foreground uppercase tracking-widest text-[10px]">
                                {t('sonOf')}
                            </p>
                            <div className="font-display">
                                ...
                                <p className="text-primary/70 text-lg py-1">&</p>
                                <p className="text-2xl md:text-3xl text-foreground font-light">
