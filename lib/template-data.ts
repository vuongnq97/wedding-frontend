...
export const invitationTemplatePageEn: WeddingData = {
    heroBannerUrl: 'https://images.unsplash.com/photo-1519741497674-611481863552?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
    groom: {
    ...
    milestones: [
        {
            ...
            date: '2018-06-15',
            title: 'First Meeting',
            description: 'We met at a lovely coffee shop downtown and talked for hours.',
        ...
        },
        {
            ...
            date: '2019-12-24',
            title: 'First Date',
            description: 'Our first official date was a magical Christmas Eve dinner.',
        ...
        },
        {
            ...
            photoUrl: 'https://joliemai.com/wp-content/uploads/2023/12/Trang-tri-tiec-cau-hon-030.jpg'
        }
    ],
    albumPhotos: [
    ...
    bankAccounts: {
        groom: [
            { id: '1', bankName: 'Chase Bank', accountNumber: '1234567890', accountHolder: 'Alexander Smith' }
        ],
        bride: [
            { id: '1', bankName: 'Bank of America', accountNumber: '0987654321', accountHolder: 'Isabella Johnson' }
        ]
    },
    music: {
        enabled: true,
...
export const invitationTemplatePageVi: WeddingData = {
    heroBannerUrl: 'https://aodaitailoc.com/wp-content/uploads/2020/08/chup-anh-cuoi-da-lat-1024x684.jpg',
    groom: {
        ...
        photoUrl: 'https://umvestnam.com/images/stories/virtuemart/product/resized/bo-vest-nam-den-tuyen-3_700x700.jpg',
    },
    bride: {
        fullName: 'Lê Thị Lan',
        informalName: 'Lan',
        ...
        photoUrl: 'https://kalina.com.vn/wp-content/uploads/2022/07/trang-diem-co-dau-mat-mun.jpg',
    },
    milestones: [
        {
            id: '1',
            ...
            description: 'Chúng mình gặp nhau tại một quán cà phê nhỏ và trò chuyện suốt hàng giờ liền.',
            photoUrl: 'https://images.unsplash.com/photo-1511632765486-a01980e01a18?auto=format&fit=crop&w=800&q=80'
        },
        {
            id: '2',
            ...
            description: 'Buổi hẹn hò chính thức đầu tiên là một bữa tối Giáng sinh ấm áp.',
            photoUrl: 'https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?auto=format&fit=crop&w=800&q=80'
        },
        {
            id: '3',
    ...
    bankAccounts: {
        groom: [
            { id: '1', bankName: 'Vietcombank', accountNumber: '1234567890', accountHolder: 'Nguyễn Văn Nam' }
        ],
        bride: [
            { id: '1', bankName: 'Techcombank', accountNumber: '0987654321', accountHolder: 'Lê Thị Lan' }
        ]
    },
    music: {
        enabled: true,
